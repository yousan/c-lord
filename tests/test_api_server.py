...
# TestReplyEndpoint removed: /api/reply and the ``discord-reply`` skill were
# retired in Issue #71.  The JSONL transcript mirror (TranscriptMirrorCog) is
# now the only path from Claude Code to Discord.
